...
let noticeBounds       = null; // {x,y,w,h} hit-box of the on-canvas nudge's close control, for tap-to-dismiss
let nurseryNoticeMuteMs = 0;   // ms timestamp: suppress re-posting the nursery nudge until then (after a dismiss)
